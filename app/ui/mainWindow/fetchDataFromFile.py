...
def fetch_and_update_rfid(rfid_tag, status_label, indicator_label, vehicle_info, window):
    """Processes the RFID tag and updates the provided text boxes."""
    if rfid_tag:
        ...
        status_label.setText("No RFID tag provided")
